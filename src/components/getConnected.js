        ...
        <div className="flex flex-col lg:flex-row w-full">
          <div className="lg:w-1/2 px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="card-item shadow-lg hover:shadow-2xl duration-500">
                <div className="flex justify-center">
                ...
                <p className="text-left text-xs mt-2 ml-5">
                  Colour LCD display
                  <br />
                  4-5 day stand-by
                  <br />
              ...
              <table className="w-full border-collapse border border-white">
                <thead>
                  <tr className="bg-gray-300">
                    ...
                    <th className="border border-white p-3 bg-[#A020F0] text-white relative">
                    ...
                    <th className="border border-white p-3 bg-[#7B14B6] text-white">
                    ...
                    <th className="border border-white p-3 bg-[#56077B] text-white">
                      <div className="text-center text-xl font-thin">
                        Ultimate<br></br>
                        <span className="text-xs text-white font-thin">
                          subscription
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-300 text-[#A020F0]">
                    <td className="border border-white p-1 ">
                      <div className="flex items-center">
                        <div className="px-3">
