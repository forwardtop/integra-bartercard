...
const Uc8AI = () => {
  return (
    <div className="flex flex-col justify-center items-center max-w-3xl m-auto pt-5">
      <div
        className="w-full bg-cover bg-center h-screen flex flex-col justify-between relative"
        ...
        <div className="absolute inset-0 bg-cover bg-center z-0  text-white">
          ...
          <div className="flex justify-center">
            <div className="p-5 lg:w-1/4 w-1/3">
              ...
              <p className="text-xs">
                Integra House Building 14, 2 Link Drive Yatala QLD 4212 Brisbane
                Australia
              </p>
            </div>
            <div className="p-5 lg:w-1/4 w-1/3">
      ...
      <div
        ...
        style={{ backgroundImage: "url(/images/phoneSystem.png)" }}
      ></div>
    </div>
  );
};
